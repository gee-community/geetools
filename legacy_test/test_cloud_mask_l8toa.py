...
image = ee.Image(TEST_CLOUD_IMAGES["L8TOA"])


def test_clouds():
    masked = cloud_mask.landsat8ToaBQA(["cloud"])(image)
...
def test_shadows():
    masked = cloud_mask.landsat8ToaBQA(["shadow"])(image)
...
def test_snow():
    masked = cloud_mask.landsat8ToaBQA(["snow"])(image)
