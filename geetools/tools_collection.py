...
class Collection(ee.collection.Collection):

    def __init__(self, *args, **kwargs):
        super(Collection, self).__init__(*args, **kwargs)

    def fill_with_last(self):
        ...
        """
        new = self.sort('system:time_start', True)
    ...
    def get_values(self, geometry, reducer=ee.Reducer.mean(), scale=None,
        ...
        propid = ee.Image(self.first()).get(id).getInfo()
        ...
        result = self.iterate(listval, ee.Dictionary({}))
