...
class Landsat(Collection):
    """  Landsat Collection """
    SHORTS = {
        'LANDSAT/LM01/C01/T1': 'L1', 'LANDSAT/LM01/C01/T2': 'L1T2',
        'LANDSAT/LM02/C01/T1': 'L2', 'LANDSAT/LM02/C01/T2': 'L2T2',
        'LANDSAT/LM03/C01/T1': 'L3', 'LANDSAT/LM03/C01/T2': 'L3T2',
        'LANDSAT/LM04/C01/T1': 'L4MSS', 'LANDSAT/LM04/C01/T2': 'L4MSST2',
        'LANDSAT/LM05/C01/T1': 'L5MSS', 'LANDSAT/LM05/C01/T2': 'L5MSST2',
        'LANDSAT/LT04/C01/T1': 'L4RAW', 'LANDSAT/LT04/C01/T1_TOA': 'L4TOA', 'LANDSAT/LT04/C01/T1_SR':'L4SR',
        'LANDSAT/LT04/C01/T2': 'L4RAWT2', 'LANDSAT/LT04/C01/T2_TOA': 'L4TOAT2', 'LANDSAT/LT04/C01/T2_SR': 'L4SRT2',
        'LANDSAT/LT05/C01/T1': 'L5RAW', 'LANDSAT/LT05/C01/T1_TOA': 'L5TOA', 'LANDSAT/LT05/C01/T1_SR': 'L5SR',
        'LANDSAT/LT05/C01/T2': 'L5RAWT2', 'LANDSAT/LT05/C01/T2_TOA': 'L5TOAT2', 'LANDSAT/LT05/C01/T2_SR': 'L5SRT2',
        'LANDSAT/LE07/C01/T1': 'L7RAW', 'LANDSAT/LE07/C01/T1_TOA': 'L7TOA', 'LANDSAT/LE07/C01/T1_SR': 'L7SR',
        'LANDSAT/LE07/C01/T2': 'L7RAWT2', 'LANDSAT/LE07/C01/T2_TOA': 'L7TOAT2', 'LANDSAT/LE07/C01/T2_SR': 'L7SRT2',
        'LANDSAT/LC08/C01/T1': 'L8RAW', 'LANDSAT/LC08/C01/T1_TOA': 'L8TOA', 'LANDSAT/LC08/C01/T1_SR': 'L8SR',
        'LANDSAT/LC08/C01/T2': 'L8RAWT2', 'LANDSAT/LC08/C01/T2_TOA': 'L8TOAT2', 'LANDSAT/LC08/C01/T2_SR': 'L8SRT2',
    }
