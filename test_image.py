...
class TestImages(unittest.TestCase):
    def setUp(self):
        ...
        self.l8SRi = geetools.Image(self.l8SR)
    ...
    def test_addConstantBands(self):
        ...
        vals = geetools.tools.get_value(newimg, self.p_l8SR_no_cloud, 30, 'client')
        ...
        vals2 = geetools.tools.get_value(newimg2, self.p_l8SR_no_cloud, 30, 'client')
        ...
        vals3 = geetools.tools.get_value(newimg3, self.p_l8SR_no_cloud, 30, 'client')
    ...
    def test_rename_bands(self):
        ...
        vals = geetools.tools.get_value(i, self.p_l8SR_no_cloud, 30, 'client')
